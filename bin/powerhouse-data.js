...
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Predator', 'The Predator', 'Str: 10, Con: 8, Dex: 10, Rec: 10', 'This is the innate talent for The Predator.<br />Con: 8, End: 5, Str: 10, Dex: 10, Int: 5, Ego: 5, Pre: 5, Rec: 10');
...
dataInnateTalent[dataInnateTalent.length] = new InnateTalent(dataInnateTalent.length, 'The Psychokinetic', 'The Psychokinetic', 'End: 8, Dex: 10, Ego: 10, Rec: 10', 'This is the innate talent for The Psychokinetic.<br />Con: 5, End: 8, Str: 5, Dex: 10, Int: 5, Ego: 10, Pre: 5, Rec: 10');
...
TravelPower = function(iTravelPowerType=null, iUnlockType=null, sName=null, sAltIcon=null, sExtra=null, sOverrideTip=null, aOtherSources=[])
{
	...
	this.tip += "<br />";
	var i, iLength;
	if (iUnlockType && iUnlockType > 0) this.tip += "<br /><b>" + TP_UNLOCKTYPES[iUnlockType] + (this.ingameCost ? " for " + this.ingameCost : "") + "</b>";
	if (aOtherSources)
	{
...
dataPowerAlias['Dependency'] = new PowerAlias('Dependency', 'Dependency', 'Dependency', 'Dependency causes the affected target to heal you or one of your nearby allies for a small amount over 20 seconds.  Can stack up to 3 times.');
dataPowerAlias['Disorient'] = new PowerAlias('Disorient', 'Disorient', 'Disorient', 'Disorient reduces the target\\\'s damage by 10% and their movement speed by 15%, lasting 12 seconds.');
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Wind Reverberation', '<div class="Sprite Wind_WindReverberation"></div>&nbsp;Wind Reverberation', 1, 4, pow++, 1, 'Wind, Energy Unlock (Endurance, <i>Recovery</i>)<br /><br />Requires 1 power from Wind or 2 non-Energy Building powers from any framework.<br /><br />You may only have 1 Energy Unlock power.<br /><br />+ generates energy every time you attempt to Repel an enemy.<br />+ This effect can only occur once every 3 seconds.<br />+ The energy gained scales with your Endurance, and to a lesser degree, your Recovery.');
dataEnergyUnlockPower[dataPower.length-1] = true;
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Icy Embrace', '<div class="Sprite Ice_IcyEmbrace"></div>&nbsp;Icy Embrace', 1, 5, pow++, 1, 'Ice, Energy Unlock (Endurance, <i>Recovery</i>)<br /><br />Requires 1 power from Ice or 2 non-Energy Building powers from any framework.<br /><br />You may only have 1 Energy Unlock power.<br /><br />+ Generates energy every time you apply Chilled to a target.<br />+ This effect can only occur once every 3 seconds and can stack up to 2 times per target.<br />+ The energy gained scales with your Endurance, and to a lesser degree, your Recovery.');
dataEnergyUnlockPower[dataPower.length-1] = true;
...
dataPowerAlias['Mechanical Monstrosity'] = new PowerAlias('Mechanical Monstrosity', 'Mechanical Monstrosity', '<div class="Sprite Technology_MechanicalMonstrosity"></div>&nbsp;Mechanical Monstrosity', 'Technology, Uncontrolled Pet<br /><br />Requires level 35<br />You may only own 1 Ultimate Power<br /><br />Summons a Mechanical Spider.<br /><br />+ Deals heavy Slashing, Electrical, and Poison damage.<br />+ Attacks have increased threat.<br />+ Can apply Debilitating Poison to foes.' + PowerUnlocksFrom("Spider Lockbox or " + UNLOCK_COLLECTOR, 1, UNLOCK_PURPLE_FOIL));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Molecular Self-Assembly', '<div class="Sprite Gadgeteering_MolecularSelfAssembly"></div>&nbsp;Molecular Self-Assembly', 2, 7, pow++, 1, 'Gadgeteering, Energy Unlock (Intelligence, <i>Recovery</i>)<br /><br />Requires 1 power from Gadgeteering or 2 non-Energy Building powers from any framework.<br /><br />You may only have 1 Energy Unlock power.<br /><br />+ Generates energy every time one of your powers comes off cooldown.<br />+ Restores energy every 3 seconds over 6 seconds.<br />+ This ability does not stack, but additional applications will refresh the duration.<br />+ The energy gained scales with your Intelligence, and to a lesser degree, your Recovery.');
dataEnergyUnlockPower[dataPower.length-1] = true;
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Overdrive', '<div class="Sprite PowerArmor_Overdrive"></div>&nbsp;Overdrive', 2, 9, pow++, 1, 'Power Armor, Energy Unlock (Recovery, <i>Endurance</i>)<br /><br />Requires 1 power from Power Armor or 2 non-Energy Building powers from any framework.<br /><br />You may only have 1 Energy Unlock power.<br /><br />+ Generates energy every 3 seconds over 9 seconds every time you use a toggle or maintain power for at least half of its duration.<br />+ This effect stacks up to 3 times.<br />+ The energy gained scales with your Recovery, and to a lesser degree, your Endurance.');
dataEnergyUnlockPower[dataPower.length-1] = true;
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Unified Theory', '<div class="Sprite LaserSword_UnifiedTheory"></div>&nbsp;Unified Theory', 2, 10, pow++, 1, 'Laser Sword, Energy Unlock (Endurance, <i>Recovery</i>)<br /><br />Requires 1 power from Laser Sword or 2 non-Energy Building powers from any framework.<br /><br />+ does not need to be slotted in Order to function.<br />+ Generates Energy every 3 seconds for 6 seconds whenever you apply a Radiation effect.  This effect does not stack, but can be refreshed.<br />+ Radiation effects include Plasma Burn, Burn Through, overheat, and Disintegrate.<br />+ scales with you Endurance and, to a lesser degree, your Recovery.');
dataEnergyUnlockPower[dataPower.length-1] = true;
...
dataPowerAlias['Steadfast'] = new PowerAlias('Steadfast', 'Steadfast', '<div class="Sprite MartialArts_Steadfast"></div>&nbsp;Steadfast', 'Martial Arts, Energy Unlock (Dexterity, <i>Recovery</i>)<br /><br />Requires 1 power from Martial Arts or 2 non-Energy Building powers from any framework.<br /><br />You may only have 1 Energy Unlock power.<br /><br />+ Generates energy every time you land a critical hit with a non-energy-building Martial Arts power.<br />+ This effect can only occur once every 3 seconds.<br />+ The energy gained scales with your Dexterity, and to a lesser degree, your Recovery.');
...
dataPowerAlias['Ego Blade Pandemonium'] = new PowerAlias('Ego Blade Pandemonium', 'Ego Blade Pandemonium', '<div class="Sprite Mentalist_EgoBladePandemonium"></div>&nbsp;Ego Blade Pandemonium', 'Mentalist, 10 foot PBAoE Sphere - Melee Damage<br /><br />Requires level 35<br />You may only own 1 Ultimate Power<br /><br />Deals Ego damage to targets every 1 sec.  Your chance to critically hit with this power is increased by 5% per stack of Ego Leech.' + PowerUnlocksFrom("Alien Invader Lockbox"));
...
dataPowerAlias['Buzzsaw'] = new PowerAlias('Buzzsaw', 'Buzzsaw', 'Buzzsaw', 'Snares your targets, reducing their movement speed by 100% for 16 sec.');
...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Incisive Wit', 'Incisive Wit', 2, null, '+ Gives this power a 15% chance to activate an Id Surge.<br />+ ' + dataPowerAlias['Id Surge'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3EB'].name, dataPowerAlias['R3EB'].desc, 2, 1, dataPowerAlias['R3EB'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Leeching Strikes', 'Leeching Strikes', 2, null, 'All attacks of this combo gain a 15% chance to grant you a stack of Ego Leech, instead of just the initial attack.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Incisive Wit', 'Incisive Wit', 2, null, '+ Gives this power a 15% chance to apply Id Surge.<br />+ ' + dataPowerAlias['Id Surge'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Weaponry', '<div class="Sprite Telekinesis_EgoWeaponary"></div>&nbsp;Ego Weaponry', 4, 15, pow++, 0, 'Telekinesis, 10 foot Melee 180/180/360 degree Cone Damage - Combo<br /><br />Deals Ego damage to the targets.  Your chance to critically strike with this power increases by 5% per stack of Ego Leech.  You have a 25/25/50% (based on combo hit) chance to gain a stack of Ego Leech, or 100% per hit if affected by Ego Infusion.  ' + dataPowerAlias['Ego Leech'].tip);
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Stressed Out', 'Stressed Out', 2, null, '+ Gives this power a 20/20/50% chance (based on combo hit) to apply Stressed.<br />+ The chance to apply Stressed is doubled if you are affected by Ego Infusion.<br />+ Stress increases Ego damage that the target receives by 8% for 20 sec and can stack up to 3 times.<br />+ Stress is a type of Mental State.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, 'Siphoning Strikes', 'Siphoning Strikes', 3, null, 'Your Ego Weaponry attacks no longer deal additional damage when you perform a critical strike with them. Instead, you heal yourself for the amount of additional damage you would have done when performing a critical strike.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Strike', '<div class="Sprite Telekinesis_TelekineticStrike"></div>&nbsp;Telekinetic Strike', 4, 15, pow++, 0, 'Telekinesis, 100 foot Ranged Single Target Combo<br /><br />Deals Ego damage to the target.  Your chance to critically strike with this power increases by 5% per stack of Ego Leech.  You have a 25/25/50% (based on combo hit) chance to gain a stack of Ego Leech, or 100% per hit if affected by Ego Infusion.  ' + dataPowerAlias['Ego Leech'].tip);
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Stressed Out', 'Stressed Out', 2, null, '+ Gives this power a 15/15/50% chance (based on combo hit) to apply Stressed.<br />+ The chance to apply Stressed is doubled if you are affected by Ego Infusion.<br />+ Stress increases Ego damage that the target receives by 8% for 20 sec and can stack up to 3 times.<br />+ Stress is a type of Mental State.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Siphoning Strikes', 'Siphoning Strikes', 3, null, '+ When this power deals a critical strike, it heals the user for the critical strike amount instead of adding it as extra damage.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(7, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Blade Astonish', '<div class="Sprite Telekinesis_EgoBladeAstonish"></div>&nbsp;Ego Blade Astonish', 4, 15, pow++, 1, 'Telekinesis, 10 foot Melee Single Target Damage - Stun<br /><br />Requires 1 power from Telekinesis or 2 non-Energy Building powers from any framework.<br /><br />Deals Ego damage and briefly Stuns the target.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, dataPowerAlias['Trauma'].name, dataPowerAlias['Trauma'].desc, 2, null, dataPowerAlias['Trauma'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Blade Frenzy', '<div class="Sprite Telekinesis_EgoBladeFrenzy"></div>&nbsp;Ego Blade Frenzy', 4, 15, pow++, 1, 'Telekinesis, 10 foot PBAoE Melee Sphere - Damage<br /><br />Requires 1 power from Telekinesis or 2 non-Energy Building powers from any framework.<br /><br />Deals Ego damage to targets.  Your chance to critically strike with this power is increased by 5% per stack of Ego Leech.  Has a 15% chance per hit to apply a stack of Ego Leech.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Unnerving Rage', 'Unnerving Rage', 2, null, 'Roots targets for 16 seconds.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Instill Doubt', 'Instill Doubt', 2, null, '+ Gives you a 25% chance to apply Dependency per hit.<br />+ ' + dataPowerAlias['Dependency'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, 'Mental Block', 'Mental Block', 3, null, 'Grants a damage absorption shield that scales up over time.  Lasts as long as you maintain this power.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(7, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinesis', '<div class="Sprite Telekinesis_Telekinesis"></div>&nbsp;Telekinesis', 4, 15, pow++, 1, 'Telekinesis, 100 foot Ranged Single Target - Pick Up and Throw Damage<br /><br />Requires 1 power from Telekinesis or 2 non-Energy Building powers from any framework.<br /><br />Levitate a nearby object and hurl it at your target, dealing Crushing damage based on the size of the object.  Also deals Crushing damage to enemies near your target.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Lariat', '<div class="Sprite Telekinesis_TelekineticLariat"></div>&nbsp;Telekinetic Lariat', 4, 15, pow++, 1, 'Telekinesis, 50 foot Ranged Single Target - Knock To Damage<br /><br />Requires 1 power from Telekinesis or 2 non-Energy Building powers from any framework.<br /><br />Deals Ego damage and Knocks your target to you.  Grants a stack of Ego Leech.  ' + dataPowerAlias['Ego Leech'].tip);
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Inner Peace', 'Inner Peace', 2, null, dataPowerAlias['SP'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Burst', '<div class="Sprite Telekinesis_TelekineticBurst"></div>&nbsp;Telekinetic Burst', 4, 15, pow++, 1, 'Telekinesis, 50 foot Ranged 15 foot Sphere - AoE Damage and Disorient<br /><br />Requires 1 power from Telekinesis or 2 non-Energy Building powers from any framework.<br /><br />Deals Ego damage to targets.<br /><br />Has a 34-100% chance (based on charge time) to Disorient targets.  ' + dataPowerAlias['Disorient'].tip + '<br /><br />Has a 34-100% chance (based on charge time) to apply Ego Leech for every target you hit.  ' + dataPowerAlias['Ego Leech'].tip);
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Reverberation', '<div class="Sprite Telekinesis_EgoReverberation"></div>&nbsp;Telekinetic Reverberation', 4, 15, pow++, 1, 'Telekinesis, Energy Unlock (Recovery, <i>Endurance</i>)<br /><br />Requires 1 power from Telekinesis or 2 non-Energy Building powers from any framework.<br /><br />You may only have 1 Energy Unlock power.<br /><br />+ Geenrates energy every 3 seconds for 6 seconds every time you apply a stack of Ego Leech.<br />+ The energy gained scales with your Recovery, and to a lesser degree, your Endurance.');
dataEnergyUnlockPower[dataPower.length-1] = true;
...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Domineering Will', 'Domineering Will', 2, null, '+ Snares the target, reducing their movement speed by 100% for 4.8 seconds.<br />+ On a full charge, Knocks Down your target.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Stressful', 'Stressful', 2, null, 'Adds 12 seconds to the duration of your Stress debuffs.  This cannot exceed the original duration of Stress.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Enhanced Form', 'Enhanced Form', 2, null, 'Grants you Aegis, increasing your Resistance to all damage by +15% for 15 sec.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Inner Peace', 'Inner Peace', 2, null, dataPowerAlias['SP'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Wave', '<div class="Sprite Telekinesis_TelekineticWave"></div>&nbsp;Telekinetic Wave', 4, 15, pow++, 2, 'Telekinesis, 50 foot Ranged 60 degree Cone AoE Damage<br /><br />Requires 3 powers from Telekinesis or 4 non-Energy Building powers from any framework.<br /><br />Deals Ego damage to targets and knocks them back based on charge time.<br /><br />Has a 34-100% chance (based on charge time) to apply a stack of Ego Leech per target hit.  ' + dataPowerAlias['Ego Leech'].tip);
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Psychic Tides', 'Psychic Tides', 2, null, '+ Sets the Energy Equilibrium of targets to 1 for 16 seconds.<br />+ Snares targets for 16 sec, reducing their movement speed by 100%.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Mental Instability', 'Mental Instability', 2, null, 'Targets are Knocked To you instead of away.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(7, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Shards', '<div class="Sprite Telekinesis_TelekineticShards"></div>&nbsp;Telekinetic Shards', 4, 15, pow++, 2, 'Telekinesis, 100 foot 10 foot Sphere - AoE Damage and Refresh<br /><br />Requires 3 powers from Telekinesis or 4 non-Energy Building powers from any framework.<br /><br />Deals Ego damage and refreshes your stacks of Ego Leech.  Your primary target is Knocked Down.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Impaled', 'Impaled', 2, null, 'Adds 12 seconds to the duration of your Stress debuffs.  This cannot exceed the original duration of Stress.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Inner Peace', 'Inner Peace', 2, null, dataPowerAlias['SP'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['NG'].name, dataPowerAlias['NG'].desc, 2, null, dataPowerAlias['NG'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(7, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Barrage', '<div class="Sprite Telekinesis_TelekineticBarrage"></div>&nbsp;Telekinetic Barrage', 4, 15, pow++, 2, 'Telekinesis, 100 foot Ranged 10 foot Sphere - AoE Damage<br /><br />Requires 3 powers from Telekinesis or 4 non-Energy Building powers from any framework.<br /><br />Deals Ego damage to targets.  Your chance to critically strike with this power is increased by 5% per stack of Ego Leech.<br /><br />You have a 20% chance per hit to gain a stack of Ego Leech.  ' + dataPowerAlias['Ego Leech'].tip);
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Dazzle', 'Dazzle', 2, null, '+ Each hit has a 20% chance to stun the target.<br />+ If you are affected by Ego Leech, the chance to stun each target becomes 20% chance per stack of Ego Leech.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, 'Instill Doubt', 'Instill Doubt', 2, null, 'Gives you a 15% chance per hit to apply Dependencey to targets.  ' + dataPowerAlias['Dependency'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Garroting Grip', 'Garroting Grip', 2, null, 'Applies Fear to your target.  Fear is a type of Mental State.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Hold', '<div class="Sprite Telekinesis_EgoHold"></div>&nbsp;Ego Hold', 4, 15, pow++, 2, 'Telekinesis, 50 foot Ranged Single Target Hold<br /><br />Requires 3 powers from Telekinesis or 4 non-Energy Building powers from any framework.<br /><br />Paralyzes the target.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Surge', '<div class="Sprite Telekinesis_EgoSurge"></div>&nbsp;Ego Surge', 4, 15, pow++, 2, 'Telekinesis, Active Offense and Energy Form<br /><br />Requires 3 powers from Telekinesis or 4 non-Energy Building powers from any framework.<br /><br />Increases your damage strength as well as your Ego stat.<br /><br />Applies Break Free damage to any Holds, Roots, or Disables affecting you.<br /><br />Shares a cooldown with other Active Offense powers.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Nimble Mind', 'Nimble Mind', 2, null, 'Increases your critical strike chance by 2% for every stack of Ego Leech you have while Ego Surge is active.'));

dataPower[dataPower.length] = new Power(dataPower.length, 'Ego Blade Annihilation', '<div class="Sprite Telekinesis_EgoBladeAnnihilation"></div>&nbsp;Ego Blade Annihilation', 4, 15, pow++, 3, 'Telekinesis, 10 foot Melee Single Target Damage<br /><br />Requires 5 powers from Telekinesis or 6 non-Energy Building powers from any framework.<br /><br />Deals Ego damage to the target.  When fully charged, this power consumes all stacks of Ego Leech to deal additional damage to your primary target and 25% of that damage to targets within 10 feet of that target.<br /><br />Grants Ego Infusion for 2 seconds per stack consumed.  Ego Infusion gives you a stack of Ego Leech every 2 seconds.<br /><br />Applies Ego Annihilation to the target for 2 sec.  This duration is increased by 2 seconds for every stack of Ego Leech consumed.  Ego Annihilation deals Ego damage every 2 seconds.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Mental Acuity', 'Mental Acuity', 2, null, '+ Increases the damage of the Ego Leech consumption portion of this power by 100%.<br />+ Increases the damage of the Ego Annihilation DoT by 50%.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));

dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Lance', '<div class="Sprite Telekinesis_TelekineticLance"></div>&nbsp;Telekinetic Lance', 4, 15, pow++, 3, 'Telekinesis, 100 foot - Ranged Single Target Damage<br /><br />Requires 5 powers from Telekinesis or 6 non-Energy Building powers from any framework.<br /><br />Deals Ego damage to the target.  When fully charged, this power consumes all stacks of Ego Leech to deal additional damage to your primary target and 25% of that damage to targets within 10 feet of that target.<br /><br />Grants Ego Infusion for 2 seconds per stack consumed.  Ego Infusion gives you a stack of Ego Leech every 2 seconds.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Maelstrom', '<div class="Sprite Telekinesis_TelekineticMaelstrom"></div>&nbsp;Telekinetic Maelstrom', 4, 15, pow++, 3, 'Telekinesis, 25 foot Sphere - PBAoE Ranged Damage and Stun<br /><br />Requires 5 powers from Telekinesis or 6 non-Energy Building powers from any framework.<br /><br />Deals Ego damage to affected targets and Stuns them for 2 seconds.  Each target hit grants you a stack of Ego Leech. ' + dataPowerAlias['Ego Leech'].tip);
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Telekinetic Assault', '<div class="Sprite Telekinesis_TelekineticAssault"></div>&nbsp;Telekinetic Assault', 4, 15, pow++, 3, 'Telekinesis, 100 foot Ranged Single Target Damage<br /><br />Requires 5 powers from Telekinesis or 6 non-Energy Building powers from any framework.<br /><br />Deals Ego damage to the target.  This damage is increased by 4% per stack of Ego Leech.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Explosive Potential', 'Explosive Potential', 2, null, 'Deals a lesser amount of damage to targets naer your primary target.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['CC'].name, dataPowerAlias['CC'].desc, 3, null, dataPowerAlias['CC'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, dataPowerAlias['Ego Blade Pandemonium'].name, dataPowerAlias['Ego Blade Pandemonium'].desc, 4, 15, pow++, 4, dataPowerAlias['Ego Blade Pandemonium'].tip);
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, dataPowerAlias['LaM'].name, dataPowerAlias['LaM'].desc, 1, null, dataPowerAlias['LaM'].tip));
...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Svengali\'s Guile', 'Svengali\'s Guile', 2, null, 'Partially refreshes the duration of your Stress, Dependency, and Regret.'));
...
dataPower[dataPower.length] = new Power(dataPower.length, dataPowerAlias['Ego Blade Pandemonium'].name, dataPowerAlias['Ego Blade Pandemonium'].desc, 4, 16, pow++, 4, dataPowerAlias['Ego Blade Pandemonium'].tip);
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, dataPowerAlias['LaM'].name, dataPowerAlias['LaM'].desc, 1, null, dataPowerAlias['LaM'].tip));
...
dataPowerAlias['Endbringers Grasp'] = new PowerAlias('Endbringer\'s Grasp', 'Endbringer\'s Grasp', '<div class="Sprite Mystic_EndbringersGrasp"></div>&nbsp;Endbringer\'s Grasp', 'Mystic, 50 foot Ranged AoE Damage and Darkness<br /><br />Requires level 35<br />You may only own 1 Ultimate Power<br /><br />Open a Qliphotic portal, its horrifying power eating away at the sanity of your foes.<br /><br />CHARGE<br />+ Open a portal that deals dimensional damage to foes.<br />+ Foes are periodically afflicted with Fear.<br />+ Foes who are afflicted by Fear are periodically corrupted and forced to fight for you.' + PowerUnlocksFrom("Villain Lockbox or " + UNLOCK_COLLECTOR, 1, UNLOCK_PURPLE_FOIL));
dataPowerAlias['Crashing Incantation'] = new PowerAlias('Crashing Incantation', 'Crashing Incantation', '<div class="Sprite Mystic_CrashingIncantation"></div>&nbsp;Crashing Incantation', 'Mystic, 50 foot Ranged AoE Damage and Curse<br /><br />Requires level 35<br />You may only own 1 Ultimate Power<br /><br />+ Deals Magic damage to targets within a 20 foot radius.<br />+ Applies Jinx to the target, reducing their movement by 15% for 8 seconds.  When the effect expires, affected foes are Knocked Down.<br />+ Jinx is a type of Curse.<br />+ Applies Overpower to affected foes, which reduces their damage resistance by 20% for 12 seconds.' + PowerUnlocksFrom("Arcane Lockbox or " + UNLOCK_COLLECTOR, 1, UNLOCK_PURPLE_FOIL));
// TODO: does not count towards unlocking in-framework power tiers
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Spirit Reverberation', '<div class="Sprite Darkness_SpiritReverberation"></div>&nbsp;Spirit Reverberation', 6, 21, pow++, 1, 'Darkness, Energy Unlock (Constitution, <i>Recovery</i>)<br /><br />Requires 1 power from Darkness or 2 non-Energy Building powers from any framework.<br /><br />You may only have 1 Energy Unlock power.<br /><br />+ Generates energy every time you attack a Feared target with Dimensional damage.<br />+ This effect can only occur once every 3 seconds.<br />+ The energy gained scales with your Constitution, and to a lesser degree, your Recovery.');
dataEnergyUnlockPower[dataPower.length-1] = true;
...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(3, 'Soul Drain', 'Soul Drain', 2, null, 'Soul Vortex now applies and refreshes Dependency on affected foes after the vortex expires.  ' + dataPowerAlias['Dependency'.tip]));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(4, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, dataPowerAlias['CS'].name, dataPowerAlias['CS'].desc, 1, null, dataPowerAlias['CS'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Wild Thing', '<div class="Sprite Supernatural_WildThing"></div>&nbsp;Wild Thing', 6, 23, pow++, 1, 'Bestial Supernatural, Energy Unlock (Endurance, <i>Recovery</i>)<br /><br />Requires 1 power from Bestial Supernatural or 2 non-Energy Building powers from any framework.<br /><br />+ Generates energy every 3 seconds for 6 seconds every time you apply, refresh, or consume a Bleed.<br />+ This effect does not stack, but triggering it again will refresh the duration.<br />+ The energy gained scales with your Endurance, and to a lesser degree, your Recovery.');
dataEnergyUnlockPower[dataPower.length-1] = true;
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Mephitic', '<div class="Sprite Supernatural_Mephitic"></div>&nbsp;Mephitic', 6, 24, pow++, 1, 'Infernal Supernatural, Energy Unlock (Endurance, <i>Recovery</i>)<br /><br />Requires 1 power from Infernal Supernatural or 2 non-Energy Building powers from any framework.<br /><br />You may only have 1 Energy Unlock power.<br /><br />+ Geenrates energy every 3 seconds for 6 seconds every time you apply or refresh a Poison.<br />+ Additional applications will refresh the effect.<br />+ The energy gained scales with your Endurance, and to a lesser degree, your Recovery.');
dataEnergyUnlockPower[dataPower.length-1] = true;
