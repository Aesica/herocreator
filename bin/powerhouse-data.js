...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['YCWS'].name, dataPowerAlias['YCWS'].desc, 2, 1, dataPowerAlias['YCWS'].tip));
...
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(5, 'Extra Bullets', 'Extra Bullets', 1, null, 'Increases the maximum number of targets you can hit with this power by 5, up from 3.'));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(6, dataPowerAlias['AM'].name, dataPowerAlias['AM'].desc, 1, null, dataPowerAlias['AM'].tip));
...
dataPowerAlias['Crashing Incantation'] = new PowerAlias('Crashing Incantation', 'Crashing Incantation', '<div class="Sprite Mystic_CrashingIncantation"></div>&nbsp;Crashing Incantation', 'Mystic, 50 foot Ranged AoE Damage and Curse<br /><br />Requires level 35<br />You may only own 1 Ultimate Power<br /><br />+ Deals Magic damage to targets within a 20 foot radius.<br />+ Applies Jinx to the target, reducing their movement by 15% for 8 seconds.  When the effect expires, affected foes are Knocked Down.<br />+ Jinx is a type of Curse.<br />+ Applies Overpower to affected foes, which reduces their damage resistance by 20% for 12 seconds.<br /><br /><b>This power can be found in the Arcane Lockbox</b>');
// TODO: does not count towards unlocking in-framework power tiers
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Celestial Conduit', '<div class="Sprite Celestial_CelestialConduit"></div>&nbsp;Celestial Conduit', 6, 20, pow++, 1, 'Celestial, 50 foot Ranged Single Target Damage and Heal<br /><br />Requires 1 power from Celestial or 2 non-Energy Building powers from any framework.<br /><br />You become a conduit for dimensional energies, focusing them on your friends or enemies.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Dark Transfusion', '<div class="Sprite Darkness_DarkTransfusion"></div>&nbsp;Dark Transfusion', 6, 21, pow++, 2, 'Darkness, Self Energy Gain and Self Damage<br /><br />Requires 3 powers from Darkness or 4 non-Energy Building powers from any framework.<br /><br />Dark Transfusion allows you to convert your own life energy into Energy for your attacks.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Ebon Ruin', '<div class="Sprite Darkness_EbonRuin"></div>&nbsp;Ebon Ruin', 6, 21, pow++, 3, 'Darkness, 100 foot Ranged Single Target Damage and DoT and Debuff<br /><br />Requires 5 powers from Darkness or 6 non-Energy Building powers from any framework.<br /><br />Assaults your foe with dimensional energy, weakening their connection to the world.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Rebirth', '<div class="Sprite Supernatural_Rebirth"></div>&nbsp;Rebirth', 6, 24, pow++, 3, 'Infernal Supernatural, Self Resurrection and Heal<br /><br />Requires 5 powers from Infernal Supernatural or 6 non-Energy Building powers from any framework.<br /><br />Rebirth allows you to recover from defeat to take vengeance upon your enemies.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, 'The Void', '<div class="Sprite Archetype_Void"></div>', 'Hybrid', ['Ego', 'Constitution', 'Presence'], 'The Void', ['Shadow Bolt', 'Shadow Blast', 'Shadow Embrace', ['Shadow Form', 'Aura of Ebon Destruction'], ['Grasping Shadows', 'Soul Vortex'], 'Concentration', 'Ebon Void', 'Ebon Ruin', 'Spirit Reverberation', 'Shadow Shroud', ['Lifedrain', 'Summon Shadows'], ['Ebon Rift', 'Void Horror']], ['Endurance', 'Guardian', 'Avenger'], 'Combat Role:  ' + aRoles[0] + '<br /><br />You are connected to a realm of shadows and darkness. This connection allows you to channel dimensional energy to assault your foes, drawing out their fears and draining them of their essence.<br /><br />Concepts: Shadow Entity, Dark Magician, Soul Vampire, Demonic Blood, Multi-Dimensional Being<br /><br />You have a good range of mid and long range attacks, both single target and group attacks. You have the ability to lock down and weaken your foes, and can learn to summon creatures of pure shadow to assist you in combat.' + ArchetypeUnlock(true, 'Nightmare Invasion'));
