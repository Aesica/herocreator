...
dataPower[dataPower.length] = new Power(dataPower.length, 'Voodoo Doll', '<img src="img/Supernatural_VoodooDoll.png" />&nbsp;Voodoo Doll', 6, 22, pow++, 1, 'Infernal Supernatural, Block<br /><br />Requires 1 power from Infernal Supernatural or 2 non-Energy Building powers from any framework.<br /><br />+ Increases all damage resistance by 250%<br />+ Deals Toxic damage to enemies that attack you while blocking.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Death\'s Embrace', '<img src="img/Supernatural_DeathsEmbrace.png" />&nbsp;Death\'s Embrace', 6, 23, pow++, 2, 'Infernal Supernatural, Resurrection<br /><br />Requires 3 powers from Infernal Supernatural or 4 non-Energy Building powers from any framework.<br /><br />brings a dead players back to life with 33/66/100% (based on rank) of their maximum health.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, 'The Predator', '<img src="img/Archetype_Predator.png" />&nbsp;The Predator', 'Melee', ['Dexterity', 'Strength', 'Recovery'], 'The Predator', ['Bestial Fury', 'Shred', ['Frenzy', 'Venomous Breath'], 'Pestilence', 'Pounce', 'Aspect of the Bestial', 'Massacre', ['Antagonize', 'Retaliaton'], 'Supernatural Power', ['Bite', 'Thrash'], ['Masterful Dodge', 'Intensity'], 'Eviscerate'], ['Dexterity', 'Vindicator', 'Warden'], 'Combat Role:  ' + aRoles[2] + '<br /><br />You are the ultimate hunter.  Once you engage your target in close combat, few can survive the fury of your assault.  You have a number of offensive attacks to wear down your enemies, all the while healing your own injuries.<br /><br />Concepts:  Savage Mutation, Evolved Insect, Genetically Enhanced, Clockwork Assassin, Arcane Hunter<br /><br />You\\\'re a close-combat offensive powerhouse.  You can cause bleeding on targets, which you can use to your advantage.  You\\\'re not as tough as other archetypes, but you can fall back on your self-healing abilities.' + ArchetypeUnlock(true));
