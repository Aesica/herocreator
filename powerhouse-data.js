...
dataFramework[dataFramework.length] = new Framework(dataFramework.length, 'Laser Sword', '<img src="img/Framework_LaserSword.png" alt="Laser Sword" />', '<b>Laser Sword</b><br /><br />Description NYI');
...
dataPower[dataPower.length] = new Power(dataPower.length, 'Rocket Punch', '<img src="img/PowerArmor_RocketPunch.png" />&nbsp;Rocket Punch', 2, 9, pow++, 1, 'Power Armor, 100 foot Ranged 1 foot Cylinder AoE Damage (Blast)<br /><br />Requires 1 power from Power Armor or 2 non-Energy Building powers from any framework.<br /><br />Fire a rocket powered fist at your target.');
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(0, null, null, null, null, null));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(1, dataPowerAlias['R2'].name, dataPowerAlias['R2'].desc, 2, null, dataPowerAlias['R2'].tip));
dataPower[dataPower.length-1].advantageList.push(new PowerAdvantage(2, dataPowerAlias['R3'].name, dataPowerAlias['R3'].desc, 2, 1, dataPowerAlias['R3'].tip));
...
dataArchetype[dataArchetype.length] = new Archetype(dataArchetype.length, 'The Automaton', '<img src="img/Archetype_Automaton.png" />&nbsp;The Automaton', 'Ranged', ['Ego', 'Recovery', 'Constitution'], 'The Scourge', ['Wrist Bolter', 'Power Gauntlet', 'Rocket Punch', 'Targeting Computer', ['Gauntlet Chainsaw', 'Chest Beam'], 'Aspect of the Machine', 'Binding Shot', 'Reconstruction Circuits', 'Overdrive', ['Lock N Load', 'Ego Surge'], ['Orbital Cannon', 'Energy Wave'], 'Implosion Engine'], ['Ego', 'Overseer', 'Vindicator'], 'Combat Role:  ' + aRoles[3] + '<br /><br />You are the most technologically advanced machine known to man. You assess targets and terminate them without hesitation.<br /><br />Concepts: Advanced Robot, Tactical Mastermind, Supercomputer Processing, Mechanized Brawler, Perfect Targeting<br /><br />You are a sentient offensive weapons platform with a shoot-first attitude. While proficient at ranged combat, you possess options for melee engagements and in-combat recovery.' + ArchetypeUnlock(false, null, 'Leveling another character to 40'));
